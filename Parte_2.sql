...
Insert into AALARCON.CAPTURAS (ID,FECHA,DEPARTAMENTO,MUNICIPIO_ID,DIA,BARRIO,ZONA,CLASE_SITIO,EDAD,SEXO,ESTADO_CIVIL,CLASE_EMPLEADO,PROFESION,ESCOLARIDAD,DELITO) values ('5018',to_date('01/01/18','DD/MM/RR'),'ANTIOQUIA','21','Lunes','CAMPO VALDES 2 C-3','URBANA','VIAS PUBLICAS','58','MASCULINO','UNION LIBRE','INDEPENDIENTE','0','0','ARTICULO 209. ACTOS SEXUALES CON MENOR DE 14 AÑOS');
...
Insert into AALARCON.CAPTURAS (ID,FECHA,DEPARTAMENTO,MUNICIPIO_ID,DIA,BARRIO,ZONA,CLASE_SITIO,EDAD,SEXO,ESTADO_CIVIL,CLASE_EMPLEADO,PROFESION,ESCOLARIDAD,DELITO) values ('5026',to_date('01/01/18','DD/MM/RR'),'ANTIOQUIA','23','Lunes','LA CHUCHITA','RURAL','VIAS PUBLICAS','33','MASCULINO','SOLTERO','INDEPENDIENTE','0','0','ARTICULO 209. ACTOS SEXUALES CON MENOR DE 14 AÑOS');
...
Insert into AALARCON.CAPTURAS (ID,FECHA,DEPARTAMENTO,MUNICIPIO_ID,DIA,BARRIO,ZONA,CLASE_SITIO,EDAD,SEXO,ESTADO_CIVIL,CLASE_EMPLEADO,PROFESION,ESCOLARIDAD,DELITO) values ('5028',to_date('01/01/18','DD/MM/RR'),'ANTIOQUIA','25','Lunes','PARQUE PRINCIPAL','URBANA','VIAS PUBLICAS','19','MASCULINO','UNION LIBRE','INDEPENDIENTE','0','0','ARTICULO 429. VIOLENCIA CONTRA SERVIDOR PÃšBLICO');
